...
#' @examples read_dengue_dataset(path = "1.data/2.ultima_semana_acumulado/DENGUE2_.txt", spatial_resolution = "state", des_edo_res = "NUEVO LEON", status_caso = c(1, 2))
read_dengue_dataset <- function(path, spatial_resolution,status_caso, des_edo_res = NULL, des_mpo_res = NULL){
    vect_cols <- c("FOL_ID","VEC_ID","IDE_EDA_ANO", "IDE_SEX",
                   ...
                   "CVE_LOC_REP", "DES_LOC_REP", "CVE_MPO_REP", "DES_MPO_REP",
                   "DES_JUR_REP", "CVE_EDO_REP", "DES_EDO_REP",
